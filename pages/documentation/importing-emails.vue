      ...
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mt-8">
          ...
          <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Import existing emails into Piler from various sources including PST files, EML files, IMAP, and POP3 accounts.
          </p>
        </div>
      </div>
    </section>
        ...
        <div class="mb-16">
          <div class="prose prose-lg dark:prose-invert max-w-none">
            <p class="text-lg text-gray-700 dark:text-gray-300 text-center mb-8">
              Documentation content coming soon. This page will provide complete instructions for importing emails into Piler.
            </p>
          </div>
        </div>
        ...
        <div class="space-y-8">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 px-6 py-4">
              <h3 class="text-xl font-bold text-white">Import from PST Files</h3>
            </div>
            <div class="p-6">
              <p class="text-gray-700 dark:text-gray-300 mb-4">Content placeholder - How to import from Microsoft Outlook PST files</p>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 px-6 py-4">
              <h3 class="text-xl font-bold text-white">Import from EML Files</h3>
            </div>
            <div class="p-6">
              <p class="text-gray-700 dark:text-gray-300">Content placeholder - Import from EML and mailbox format files</p>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div class="p-6">
              <p class="text-gray-700 dark:text-gray-300">Content placeholder - Import directly from email accounts</p>
            </div>
          </div>

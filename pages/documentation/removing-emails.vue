        ...
        <div class="space-y-8">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 px-6 py-4">
              <h3 class="text-xl font-bold text-white">Enable message removal from the UI</h3>
            </div>
            <div class="p-6">
              <p class="text-gray-700 dark:text-gray-300 mb-4">Set the following in config-site.php</p>
              <div class="bg-gray-900 dark:bg-gray-950 rounded-lg mb-4 p-4">
                <code class="text-green-400 text-sm font-mono">$config['ENABLE_DELETE'] = 1;</code>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 px-6 py-4">
              <h3 class="text-xl font-bold text-white">Remove a message</h3>
            </div>
            <div class="p-6">
              <p class="text-gray-700 dark:text-gray-300 mb-4">
                When the feature is enabled, auditor users are allowed to mark emails for removal. When an auditor selects a message for removal, he clicks on the delete icon in the middle bar of the screen to artificially set its retention value to the past. He also needs to specify a reason for the removal which will be stored in the mysql database for later reference for the action.</p>

	      <p class="text-gray-700 dark:text-gray-300 mb-4">When using RT index, the UI deletes the message from the search index, so the message doesn't appear on the UI.
Then when the daily purge utility runs, it will remove the email physically from the archive.</p> 
            </div>
          </div>
